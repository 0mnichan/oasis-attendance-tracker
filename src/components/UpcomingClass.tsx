  ...
  return (
    <div className="glass-panel p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold">Upcoming Hour</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t">
          ...
          <div>
            <p className="text-sm text-muted-foreground mb-1">Can You Miss?</p>
            {canMiss ? (
        ...
        <div className="pt-4 border-t">
          <p className="text-sm text-muted-foreground mb-2">If you miss this class:</p>
          <div className="flex items-center justify-between bg-muted/50 p-3 rounded-lg">
            <div>
              <p className="text-xs text-muted-foreground">Attendance will drop to</p>
              <p className={`text-xl font-bold ${percentageIfMissed >= 75 ? 'text-primary' : 'text-destructive'}`}>
